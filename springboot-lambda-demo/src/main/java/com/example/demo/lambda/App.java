...
//        // 匿名内部类，实现接口的抽象方法
        ...
        // 三、JDK8 提供的常见函数式接口 Predicate、Consumer
        /**
         *      接收参数值，返回Boolean类型
         *   // java.util.function.Predicate<T>  接口对于传递的对象或者参数接口进行校验 ，返回true or false
         */
